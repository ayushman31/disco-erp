...
- to create bucket run :
    aws --endpoint-url http://localhost:8333 --profile seaweedfs s3 mb s3://discoERP
...
- to check recordings : aws --profile seaweedfs --endpoint-url http://localhost:8333 s3 ls s3://discoERP/media/     (this would give users)
